use crate::conv::{serde_v8_error_to_json, anyhow_error_to_json};
...
impl Engine {
    ...
    pub fn new() -> Self {
        ...
        new_engine.runtime.execute_script_static("[core:runtime]", include_str!("./runtime.js")).unwrap();
